...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Melville Swimming Pool",
    phone:     "+27 76 621 6868",
    whatsapp:  "+27 76 621 6868",
    address:   "Main Rd &, 4th Ave, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Melville Swimming Pool — Pool services in johannesburg",
    description: "Melville Swimming Pool provides professional pool services in Johannesburg. 48 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Melville Swimming Pool keeps swimming pools clean, chemically balanced and fully functional across Johannesburg. Maintenance, repairs, pump and filter work — we handle it all.",
    ...
    band: {
      ...
      alt:   "Melville Swimming Pool team at work in Johannesburg",
    ...
    // ─── REVIEWS ───────────────────────────────────────────
    reviewsTitle: "From 48 verified Google reviews.",
    reviews: [
      {
